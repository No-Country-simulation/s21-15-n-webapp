  ...
  return (
    <DashboardLayout>
      <div className="relative">
        <div className="bg-background/60 backdrop-blur-xl min-h-screen min-w-screen text-white rounded-lg">
          {/* Sidebar
          ...
          <div className="flex h-screen p-4 z-3">
            {/* Sección de mensajes */}
            <div className="bg-background/60 backdrop-blur-xl border border-[#4F46E5] rounded-lg w-[35%] mr-4 p-3 overflow-y-auto">
              ...
              {filteredMessages.map((msg, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-3 hover:bg-background/60 backdrop-blur-xl transition-all border-y border-y-[#4F46E5]"
                >
            ...
            <div className="border border-[#4F46E5] rounded-lg w-[65%] bg-background/60 backdrop-blur-xl p-4 relative">
              <div className="flex mb-5 mt-15">
                ...
                >
                    <option value="" className="bg-background/60 backdrop-blur-xl ">Seleccionar destinatario</option>
                    {destinatarios.map((dest, idx) => (
                        <option key={idx} value={dest.value} className="!bg-background backdrop-blur-4xl">
                        {dest.nombre}
                        </option>
                    ))}
                </select>
