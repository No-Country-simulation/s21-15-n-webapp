...
const CONQUISTAS = [
  {
    ...
    description: "Desbloquea insignias especiales al completar misiones y desafíos en diferentes tecnologías",
  },
  {
    icon: <Rocket className="h-6 w-6 text-primary" />,
    title: "Piloto Intergalactico",
    description: "Alcanza nuevos niveles y rangos que demuestran tu experiencia en el universo tech",
  },
  {
