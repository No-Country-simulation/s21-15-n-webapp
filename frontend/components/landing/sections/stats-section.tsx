...
import { StatsItem } from "@/config/types/landing"
    ...
    <section className="py-24 bg-background">
      <div className="container px-4">
        <h2 className="mb-16 text-center text-3xl font-bold text-white md:text-4xl">
          Nuestro viaje intergalactico ha dejado huella en el universo tech
        </h2>
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {LANDING_CONFIG.stats.items.map((stat: StatsItem ) => (
